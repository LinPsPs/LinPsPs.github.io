...
import 'package:profolio/Model/method.dart';
import 'package:profolio/UI/about.dart';
import 'package:profolio/UI/feature_project.dart';
import 'package:profolio/UI/work.dart';
                        ...
                        child: Padding(
                          ...
                          child: DefaultTabController(
                            ...
                            child: TabBar(
                              ...
                              tabs: [
                                for (String title in Data.appbarTitle)
                                  Tab(
                                    child: AppBarTitle(
                                      text: title,
                                    ),
                    ...
                    child: Column(
                      ...
                      children: [
                        IconButton(
                            ...
                            iconSize: 16.0,
                            onPressed: () {
                              method.launchURL(Data.github);
                            }),
                        IconButton(
                          icon: const FaIcon(FontAwesomeIcons.linkedin),
                          color: const Color(0xffffa8b2d1),
                          onPressed: () {
                            method.launchURL(Data.linkedin);
                          },
                          iconSize: 16.0,
                        ),
                        // IconButton(
                            ...
                            SliverList(
                              ...
                              _wrapScrollTag(
                                  ...
                                  child: Column(children: [
                                    const MainTitle(
                                      number: "0.3",
                                      text: "Something I've Built",
                                    ),
                                    SizedBox(
                                      height: size.height * 0.04,
                                    ),
                                    for (Map<String, String> project
                                        in Data.projects)
                                      FeatureProject(
                                        imagePath:
                                            'images/' + project['imageName']!,
                                        ontab: () {
                                          method.launchURL(
                                              project['githubLink']!);
                                        },
                                        ...
                                        tech1: project['techUsed1'],
                                        tech2: project['techUsed2'],
